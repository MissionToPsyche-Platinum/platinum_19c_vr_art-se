...
class MyTestCase(unittest.TestCase):
    ...
    def testGetArtInfo2025(self):
        ...
        self.assertEqual(info["date"], "July 2nd, 2025")
        ...
        self.assertEqual(info["file_paths"], [os.path.join("psyche_media", "Psyche_Inspired_24-25_ASoriano_TheLaunch_4.1_4.9.25-Ash-Soriano.png")])
    ...
    def testGetArtInfo2017(self):
        ...
        self.assertEqual(info["date"], "November 18, 2017")
        ...
        self.assertEqual(info["file_paths"], [os.path.join("psyche_media", "Psyche_Inspired_17-18_IWisdom_Project1_Ideas_171118.png")])
