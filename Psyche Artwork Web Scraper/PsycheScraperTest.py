...
class MyTestCase(unittest.TestCase):
    ...
    def testGetArtInfo2025(self):
        ...
        self.assertEqual(info[0], "The Launch")
        self.assertEqual(info[1], "Ash Soriano")
        self.assertEqual(info[2], "July 2nd, 2025")
        self.assertEqual(info[3], "Media Arts & Sciences")
        self.assertEqual(info[4], "Digital (Procreate)")
        ...
        self.assertEqual(info[5], description)
    ...
    def testGetArtInfo2017(self):
        ...
        self.assertEqual(info[0], "Ideas")
        self.assertEqual(info[1], "Isaac Wisdom")
        self.assertEqual(info[2], "November 18, 2017")
        self.assertEqual(info[3], "Music and culture")
        self.assertEqual(info[4], "Composition")
