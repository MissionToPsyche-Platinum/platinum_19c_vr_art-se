...
class MyTestCase(unittest.TestCase):
    ...
    def testGetArtInfo2025(self):
        ...
        self.assertEqual(info["file_paths"], [os.path.join("Assets", "Artwork", "6621986371799769726", "Psyche_Inspired_24-25_ASoriano_TheLaunch_4.1_4.9.25-Ash-Soriano.png")])
    ...
    def testGetArtInfo2017(self):
        ...
        self.assertEqual(info["file_paths"], [os.path.join("Assets", "Artwork", "6587082944754327409", "Psyche_Inspired_17-18_IWisdom_Project1_Ideas_171118.png")])
