...
Windows- 
1).Download ffmpeg from the following site (https://www.ffmpeg.org/download.html#build-windows). Simply using pip install ffmpeg WILL NOT WORK, as it does not contain the executable file required. 
...
10).Try rerunning the program. You may need to reboot the terminal for the new path to take effect.
MacOS-
Linux-
