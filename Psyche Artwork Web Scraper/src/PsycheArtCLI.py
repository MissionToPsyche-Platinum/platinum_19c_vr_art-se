import src.db_modification.DatabaseUpdater as DatabaseUpdater
from src.db_modification.AddArtProject import *
from src.db_modification.ModifyArtProject import *

if __name__ == '__main__':
    print("""Welcome to the Psyche VR Museum CLI Interface!  What would you like to do?
        1: Update the Database with a new CSV
