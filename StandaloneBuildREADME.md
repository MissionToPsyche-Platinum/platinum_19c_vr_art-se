...
10. IF BUILDING FROM ARTWORK FOLDER: Run `.\Update_Artwork.ps1 -B` in this directory. Otherwise just running `.\Update_Artwork.ps1` with a valid Bundles folder will install the bundles to the headset.
